...
@Entity
@Table(name = "cliente")
@NamedQueries({ @NamedQuery(name = "cliente.consultarCliente", query = "SELECT c " + "FROM cliente c"
...
public class Cliente implements Serializable {
	...
	public String toString() {
		return "Cliente{" + "idCli=" + idCli + ", cliCpf=" + cliCpf + ", nome=" + nome + ", login=" + login + ", senha="
				+ senha + ", endere\u00e7o=" + endereço + '}';
	}

	public boolean cadastroCli(Cliente cliente) {
		listacli.add(cliente);
		if (listacli.add(cliente)) {
